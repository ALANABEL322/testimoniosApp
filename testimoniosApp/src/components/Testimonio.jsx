    ...
    <div className="contenedor-testimonio">
      ...
      <div className="contenedor-text-testimonio">
        ...
        <p className="texto-testimonio">
          "Siempre he tenido probelmas para aprender JavaScript. He tomado
          muchos cursos, Estudiar JavaScript, así como estructuras de datos y
          algoritmos en diferentes cursos me dieron la habilidad y la confianza
